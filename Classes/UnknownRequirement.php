...
use JayBeeR\Exceptionist\Scope\RequirementScope;

/**
 *
 */
class UnknownRequirement extends Exception implements DeficiencyReason, AbsenceReason, CompatibilityReason, RequirementScope
{
